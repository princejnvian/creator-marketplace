-- YOUTENT v4: direct creator messaging + marketplace ledger support.
...
-- Keep the existing marketplace profile columns available.
...
-- Basic validation for starting price.
ALTER TABLE public.profiles
